...
# Normalizer + OldClassifier
class OldClassifierWrapper:
    ...
    def __init__(self, thresholdLP = 4, LPresistance = 60*10, thresholdPD = 1, sampleRate = 10000, maxCalibrateNormalization = 5):
        ...
        self.oldClassifier = OldClassifier(thresholdLP = thresholdLP, LPresistance = LPresistance, thresholdPD = thresholdPD)
    ...
    def predict(self, dataExtra, dataPD, normalized=False):
        ...
        classification = self.oldClassifier.classify(dataExtra, dataPD)
